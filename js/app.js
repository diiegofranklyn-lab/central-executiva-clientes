...
.nav .icon{width:20px;height:20px;flex-basis:20px;display:grid;place-items:center;position:relative;color:#fff;font-size:16px;line-height:1;font-family:Arial,sans-serif;font-weight:400}
.nav .icon:before,.nav .icon:after{content:none!important;display:none!important;background:none!important;mask:none!important;-webkit-mask:none!important}
.nav a[data-page="dashboard"] .icon,.nav a[data-page="solicitacoes"] .icon,.nav a[data-page="clientes"] .icon,.nav a[data-page="relatorios"] .icon{font-size:16px}
